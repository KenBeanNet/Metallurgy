...
public class FF_ContainerMetalFurnace extends Container
{
    ...
    public FF_ContainerMetalFurnace(InventoryPlayer var1, FF_TileEntityMetalFurnace var2)
    {
        this.furnace = var2;
        this.addSlotToContainer(new Slot(var2, 0, 56, 17));
        this.addSlotToContainer(new Slot(var2, 1, 56, 53));
        this.addSlotToContainer(new FF_SlotMetalFurnace(var1.player, var2, 2, 116, 35));
        int var3;
    ...
    public ItemStack transferStackInSlot(EntityPlayer var1, int var2)
    {
        ...
        if (var4 != null && var4.getHasStack())
        {
            ...
            {
                if (FF_EssenceRecipes.essence().getEssenceResult(var5) != 0)
                {
                ...
                else if (FF_TileEntityMetalFurnace.isItemFuel(var5))
                {
