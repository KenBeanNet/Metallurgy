...
public class EntityOreFX extends EntityFX
{
    ...
    public void renderParticle(Tessellator var1, float var2, float var3, float var4, float var5, float var6, float var7)
    {
        ...
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, ModLoader.getMinecraftInstance().renderEngine.getTexture("/shadow/NetherMetalsParticle.png"));
        ...
        float var19 = 1.0F;
        var8.setColorRGBA_F(this.particleRed, this.particleGreen, this.particleBlue, 0.5F);
    ...
    public void onUpdate()
    {
        ...
        if (this.particleAge == this.particleMaxAge * 3 / 4)
        {
            this.setParticleTextureIndex(3);
        }
        else if (this.particleAge == this.particleMaxAge * 2 / 4)
        {
            this.setParticleTextureIndex(2);
        }
        else if (this.particleAge == this.particleMaxAge * 1 / 4)
        {
