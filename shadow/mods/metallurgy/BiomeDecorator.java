...
public class BiomeDecorator
{
    ...
    public static int diamoundVeinCount = 1;
    public static int diamoundOreCount = 7;
    ...
    public BiomeDecorator(BiomeGenBase var1)
    {
        ...
        this.diamondGen = new WorldGenMinable(Block.oreDiamond.blockID, diamoundOreCount);
    ...
    protected void generateOres()
    {
        ...
        this.genStandardOre1(diamoundVeinCount, this.diamondGen, 0, diamondMaxHeight);
