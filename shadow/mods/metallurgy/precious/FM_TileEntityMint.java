...
public class FM_TileEntityMint extends TileEntity
{
    ...
    public void power()
    {
        if (this.ingotId == 0)
        {
            ...
            for (var1 = -1; var1 <= 1; var1 += 2)
            {
                ...
                if (var2 instanceof FM_TileEntityMintStorage)
                {
                    ...
                    for (var4 = 0; var4 < var3.getSizeInventory(); ++var4)
                    {
                        ...
                        if (var5 != null && FM_MintRecipes.minting().getMintingResult(var5) > 0)
                        {
    ...
    public void setIngot(int var1, IInventory var2)
    {
        ...
        {
            this.amount = FM_MintRecipes.minting().getMintingResult(var2.getStackInSlot(var1));
    ...
    public ItemStack currentIngot()
    {
        ...
        return this.ingotId != 0 && this.amount == FM_MintRecipes.minting().getMintingResult(var1) ? var1 : null;
    }
    ...
    public void mint()
    {
        ItemStack var1 = new ItemStack(MetallurgyPrecious.Coin, 1, 0);
        ...
        if (!this.worldObj.isRemote && this.hasIngot())
        {
            ...
            for (var3 = -1; var3 <= 1; var3 += 2)
            {
                ...
                if (var4 instanceof IInventory && !(var4 instanceof FM_TileEntityMintStorage))
                {
    ...
    {
        if (this.amount > FM_MintRecipes.minting().getMintingResult(new ItemStack(this.ingotId, 1, 0)))
        {
            this.amount = FM_MintRecipes.minting().getMintingResult(new ItemStack(this.ingotId, 1, 0));
        }
    ...
    {
        return this.ingotId == MetallurgyPrecious.ores.Bar[1].itemID ? "/shadow/MintSilver.png" : (this.ingotId == MetallurgyPrecious.alloys.Bar[0].itemID ? "/shadow/MintBrass.png" : (this.ingotId == MetallurgyPrecious.alloys.Bar[1].itemID ? "/shadow/MintElectrum.png" : (this.ingotId == MetallurgyPrecious.ores.Bar[2].itemID ? "/shadow/MintPlatinum.png" : (this.ingotId == Item.ingotGold.itemID ? "/shadow/MintGold.png" : (!FM_MintRecipes.minting().getImage(this.ingotId).equals("") ? FM_MintRecipes.minting().getImage(this.ingotId) : "/shadow/MintBrass.png")))));
    }
}
