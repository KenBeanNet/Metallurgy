...
public class MetallurgyWorldGenEnderMinable extends WorldGenerator
{
    private int minableBlockId;
    private int metadata;
    private int numberOfBlocks;

    public MetallurgyWorldGenEnderMinable(int var1, int var2, int var3)
    {
                    ...
                    for (int var41 = var33; var41 <= var36; ++var41)
                    {
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D)
                        {
                            for (int var44 = var34; var44 <= var37; ++var44)
                            {
                                ...
                                if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && var1.getBlockId(var38, var41, var44) == Block.whiteStone.blockID)
                                {
                                    var1.setBlock(var38, var41, var44, this.minableBlockId);
                                    var1.setBlockMetadata(var38, var41, var44, this.metadata);
                                }
                            }
                        }
                    }
