...
public class BC_ContainerCrusher extends Container
{
    ...
    public BC_ContainerCrusher(InventoryPlayer var1, BC_TileEntityCrusher var2)
    {
        this.furnace = var2;
        this.addSlotToContainer(new Slot(var2, 0, 56, 17));
        this.addSlotToContainer(new Slot(var2, 1, 56, 53));
        this.addSlotToContainer(new BC_SlotCrusher(var1.player, var2, 2, 116, 35));
        int var3;
    ...
    public ItemStack transferStackInSlot(EntityPlayer var1, int var2)
    {
        ...
        if (var4 != null && var4.getHasStack())
        {
            ...
            {
                if (BC_CrusherRecipes.smelting().getCrushingResult(var5) != null)
                {
                ...
                else if (BC_TileEntityCrusher.isItemFuel(var5))
                {
