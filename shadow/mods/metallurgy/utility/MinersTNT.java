...
{
    public MinersTNT(int var1, int var2)
    {
        super(var1, var2);
    ...
    public void onBlockDestroyedByExplosion(World var1, int var2, int var3, int var4)
    {
        if (!var1.isRemote)
        {
            EntityMinersTNTPrimed var5 = new EntityMinersTNTPrimed(var1, (double)((float)var2 + 0.5F), (double)((float)var3 + 0.5F), (double)((float)var4 + 0.5F));
    ...
    public void onBlockDestroyedByPlayer(World var1, int var2, int var3, int var4, int var5)
    {
        ...
        {
            EntityMinersTNTPrimed var6 = new EntityMinersTNTPrimed(var1, (double)((float)var2 + 0.5F), (double)((float)var3 + 0.5F), (double)((float)var4 + 0.5F));
