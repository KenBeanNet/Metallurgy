...
public class EntityMinersTNTPrimed extends Entity
{
    public int fuse;

    public EntityMinersTNTPrimed(World var1)
    {
        super(var1);
        this.fuse = 0;
    ...
    public EntityMinersTNTPrimed(World var1, double var2, double var4, double var6)
    {
        this(var1);
    ...
    {
        float var1 = 10.0F;
        ExplosionMiners var2 = new ExplosionMiners(this.worldObj, (Entity)null, this.posX, this.posY, this.posZ, var1);
