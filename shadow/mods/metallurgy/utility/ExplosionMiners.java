...
public class ExplosionMiners extends Explosion
{
    ...
    public ExplosionMiners(World var1, Entity var2, double var3, double var5, double var7, float var9)
    {
    ...
    public void doExplosionA()
    {
                    ...
                    if (var3 == 0 || var3 == this.field_77289_h - 1 || var4 == 0 || var4 == this.field_77289_h - 1 || var5 == 0 || var5 == this.field_77289_h - 1)
                    {
                        ...
                        for (float var21 = 0.3F; var20 > 0.0F; var20 -= var21 * 0.75F)
                        {
                            ...
                            if (var25 > 0)
                            {
                                ...
                                float var27 = this.exploder != null ? this.exploder.func_82146_a(this, var26, var22, var23, var24) : var26.getExplosionResistance(this.exploder, this.worldObj, var22, var23, var24, this.explosionX, this.explosionY, this.explosionZ);

                                if (MetallurgyUtility.isOre(var25))
                                {
                                    var27 = 2000.0F;
                                }
        ...
        List var15 = this.worldObj.getEntitiesWithinAABBExcludingEntity(this.exploder, AxisAlignedBB.getAABBPool().addOrModifyAABBInPool((double)var3, (double)var5, (double)var13, (double)var4, (double)var28, (double)var29));
        ...
        for (int var17 = 0; var17 < var15.size(); ++var17)
        {
            ...
            if (var19 <= 1.0D)
            {
                ...
                var8 = var31.posY + (double)var31.getEyeHeight() - this.explosionY;
                ...
                if (var33 != 0.0D)
                {
                    ...
                    {
                        this.field_77288_k.put((EntityPlayer)var31, this.worldObj.getWorldVec3Pool().getVecFromPool(var6 * var34, var8 * var34, var10 * var34));
                    }
                }
            }
        }
