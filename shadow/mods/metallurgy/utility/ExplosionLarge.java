...
public class ExplosionLarge extends Explosion
{
    ...
    public ExplosionLarge(World var1, Entity var2, double var3, double var5, double var7, float var9)
    {
                    ...
                    if (var3 == 0 || var3 == this.field_77289_h - 1 || var4 == 0 || var4 == this.field_77289_h - 1 || var5 == 0 || var5 == this.field_77289_h - 1)
                    {
                        ...
                        for (float var21 = 0.3F; var20 > 0.0F; var20 -= var21 * 0.75F)
                        {
                            ...
                            if (var25 > 0)
                            {
                                ...
                                {
                                    var26.getExplosionResistance(this.exploder, this.worldObj, var22, var23, var24, this.explosionX, this.explosionY, this.explosionZ);
                                }
                            }
